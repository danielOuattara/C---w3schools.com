...
Line 1: #include <iostream> :: is a header file library that
        lets us work with input and output objects, such as
        "cout" (used in line 15). Header files add functionality
        to C++ programs.
...
and "using namespace std" works.
Just think of it as something that (almost) always appears
in your program.


Line 3: A blank line. C++ ignores white space.

Line 4: Another thing that always appears in a C++ program,
        is 'int main()'. This is called a function. Any code
...
CAUTION: Every C++ statement ends with a semicolon ";"
